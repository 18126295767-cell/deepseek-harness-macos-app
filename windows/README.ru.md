...
Интерфейс проверен на настоящем Runner `windows-2025` с новым пустым профилем браузера:

![Пустое рабочее пространство официального DSH в Windows](../docs/images/windows-03-empty-workspace.png)

Официальные настройки показывают список плагинов runtime:

![Список плагинов официального DSH в Windows](../docs/images/windows-05-plugin-inventory.png)

[Отчёт о снимках](../docs/images/README.md) содержит происхождение Runner, SHA-256, OCR-проверку конфиденциальности и результаты визуальной проверки.
